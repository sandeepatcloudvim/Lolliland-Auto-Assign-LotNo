pageextension 54511 "LOLI_ExtendWarehouseShipment" extends "Warehouse Shipment"
{
    layout
    {
    ...
    var
        RecWhShipmentLine: Record "Warehouse Shipment Line";
    ...
    begin
        ...
        IF RecWhShipmentLine.FINDSET THEN begin
            if RecWhShipmentLine."Location Code" IN ['WA', 'SA', 'NSW', 'QLD', 'VIC', 'TAS', 'AUCK NZ', 'CHRISTC NZ'] then begin
                LOLIDeleteReservationEntry(RecWhShipmentLine);
                REPEAT
                    IF ItemRec.GET(RecWhShipmentLine."Item No.") THEN BEGIN
    ...
    begin
        ...
        ReservEntry.SETRANGE("Source ID", WarehouseShipmentLine."Source No.");
        IF ReservEntry.FINDSET THEN
            ReservEntry.DELETEALL;
    end;

    procedure LOLIDeleteUnusedReservationEntry(ItemNo: Code[20])
    var
        recSalesLine: Record "Sales Line";
    begin
    ...
    begin
        ...
        CurrLotNo := '';
        RequiredSaleLineQty := SalesLine.Quantity;
    ...
    begin
        ...
        ErrorTable."Field Number" := LocSalesLine.FIELDNO(LocSalesLine.Quantity);
        ...
        ErrorTable."Field Name" := LocSalesLine.FIELDNAME(Quantity);
